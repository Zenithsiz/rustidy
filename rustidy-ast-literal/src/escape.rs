...
pub struct QuoteEscape(#[parse(try_update_with = Self::parse)] #[format(str)] pub AstStr);
...
pub struct AsciiEscape(#[parse(try_update_with = Self::parse)] #[format(str)] pub AstStr);
...
pub struct ByteEscape(#[parse(try_update_with = Self::parse)] #[format(str)] pub AstStr);
...
pub struct NonNulByteEscape(#[parse(try_update_with = Self::parse)] #[format(str)] pub AstStr);
...
pub struct UnicodeEscape(#[parse(try_update_with = Self::parse)] #[format(str)] pub AstStr);

impl UnicodeEscape {
	pub fn parse(s: &mut &str) -> Result<(), UnicodeEscapeError> {
		*s = s
			.strip_prefix("\\u{")
			.ok_or(UnicodeEscapeError::Escape)?;
...
#[parse(error(name = Nul, fmt = "Nul escape isn't allowed", fatal))]
pub struct NonNulUnicodeEscape(#[parse(try_update_with = Self::parse)] #[format(str)] pub AstStr);
...
pub struct StringContinue(#[parse(try_update_with = Self::parse)] #[format(str)] pub AstStr);
