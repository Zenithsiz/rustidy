...
#[format(no_prefix_ws)]
pub struct RemainingLine(#[parse(update_with = Self::parse)] #[format(str)] pub AstStr);
...
pub struct RemainingBlockComment(#[parse(try_update_with = Self::parse)] #[format(str)] pub AstStr);
